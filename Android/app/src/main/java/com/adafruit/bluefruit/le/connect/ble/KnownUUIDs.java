...
public class KnownUUIDs extends StandardUUIDs {
    ...
    static {
        ...
        aMap.put("6e400001-b5a3-f393-e0a9-e50e24dcca9e".toUpperCase(), "Nordic UART");
    ...
    static {
        ...
        // Uart
        aMap.put(UUID_RX.toUpperCase(), "RX Buffer");
        aMap.put(UUID_TX.toUpperCase(), "TX Buffer");
        aMap.put("00001530-1212-EFDE-1523-785FEABCD123".toUpperCase(), "DFU Service");
